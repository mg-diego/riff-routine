...
export default function ExerciseDetailsPage() {
    ...
    const fetchExercise = async () => {
        try {
            ...
            if (dbError || !data) throw new Error('No se pudo cargar el ejercicio.');
    ...
    if (!exercise) return <div style={{ color: 'var(--text)', textAlign: 'center', padding: '4rem' }}>Ejercicio no encontrado.</div>;
                        ...
                        {file ? (
                            ...
                            <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                                ...
                                <div style={{ textAlign: 'left' }}>
                                    <p style={{ color: 'var(--gold)', margin: 0, fontWeight: 600, fontSize: '0.95rem' }}>Reemplazar archivo (Opcional)</p>
                                    <p style={{ color: 'var(--muted)', margin: 0, fontSize: '0.8rem' }}>Arrastra un nuevo GP o haz clic</p>
                                </div>
                            </div>
                        ) : (
                            <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
                                ...
                                <div style={{ textAlign: 'center' }}>
                                    <p style={{ color: 'var(--muted)', margin: 0, fontWeight: 600, fontSize: '0.95rem' }}>
                                        Archivo Guitar Pro <span style={{ fontWeight: 400, fontSize: '0.85rem' }}>(opcional)</span>
                                    </p>
                                    <p style={{ color: 'rgba(106,95,82,0.6)', margin: 0, fontSize: '0.8rem' }}>GP3, GP4, GP5, GPX · arrastra o haz clic</p>
                                </div>
                            </div>
                        )}
                    </div>
