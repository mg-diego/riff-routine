...
export default function LoginPage() {
  ...
  const handleAuth = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (isLogin) {
      ...
      if (error) setError(error.message); // Nota: Supabase devuelve errores en inglés por defecto
  ...
  const features = [
    {
      ...
      title: t('features.tabsTitle'), text: t('features.tabsText')
    },
    {
      icon: (
        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      ...
      title: t('features.routinesTitle'), text: t('features.routinesText')
    },
    {
      icon: (
        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      ...
      title: t('features.trackingTitle'), text: t('features.trackingText')
    },
    {
      icon: (
        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      ...
      title: t('features.statsTitle'), text: t('features.statsText')
    },
  ];
    ...
    <>
      ...
      <div className="login-root">
        ...
        <div className="login-left">
          <a href="/" className="left-logo" style={{ display: "inline-flex", alignItems: "center", textDecoration: "none", gap: "0.5rem" }}>
            <img src="/favicon.ico" alt="RiffRoutine" style={{ width: "24px", height: "24px", borderRadius: "4px", flexShrink: 0 }} />
            <span><span style={{ color: "#dcb98a" }}>Riff</span><span style={{ color: "#f0e8dc" }}>Routine</span></span>
          </a>
          ...
          <div className={`glass-widget widget-1 ${mounted ? 'visible' : ''}`}>
            ...
            <div className="widget-text">
              <span className="widget-label">{t('leftPanel.widget1Label')}</span>
              <span className="widget-val">{t('leftPanel.widget1Val')}</span>
            </div>
          </div>
          ...
          <div className={`glass-widget widget-2 ${mounted ? 'visible' : ''}`}>
            <div className="widget-icon">⚡</div>
            <div className="widget-text">
              <span className="widget-label">{t('leftPanel.widget2Label')}</span>
              <span className="widget-val">{t('leftPanel.widget2Val')}</span>
            </div>
          </div>
          ...
          <div className="left-hero">
            <h1 className="left-title">
              ...
              {t('leftPanel.titleLine2')} <span className="gold">{t('leftPanel.titleLine2Gold')}</span><br />
              <span className="outline">{t('leftPanel.titleLine3')}</span>
            </h1>
        ...
        <div className="login-right">
          <div className={`form-wrap ${mounted ? 'visible' : ''}`}>
            ...
            <div className="form-title">{isLogin ? t('form.titleLogin') : t('form.titleSignup')}</div>
            <div className="form-sub">{isLogin ? t('form.subLogin') : t('form.subSignup')}</div>
            ...
            <form onSubmit={handleAuth}>
              ...
              <button type="submit" className="btn-primary" disabled={loading}>
                ...
                {loading ? t('form.loading') : isLogin ? t('form.btnSubmitLogin') : t('form.btnSubmitSignup')}
              </button>
            </form>

            <div className="divider">
              <div className="divider-line" />
              <span className="divider-text">{t('form.divider')}</span>
              <div className="divider-line" />
            </div>

            <button className="btn-demo" onClick={handleDemo} disabled={loading}>
              🎸 <span>{t('form.btnDemo')}</span>
            </button>
